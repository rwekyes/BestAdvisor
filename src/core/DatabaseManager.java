...
public class DatabaseManager {
    ...
    private DatabaseManager() {
        // This is the private constructor for the database manager
        // HikariConfig is from the imported library
    ...
    // The following few methods take in parameters to find tables, then grab tables that have been joined
    // in each of the different cardinalities
    ...
    // shuts off the connection, super useful method but not used in this manager
